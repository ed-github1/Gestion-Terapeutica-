...
const Sidebar = ({ isOpen, onClose }) => {
    const { user, logout, isHealthProfessional } = useAuth()
    ...
    const navItems = isHealthProfessional() ? professionalNavItems : patientNavItems
    ...
    return (
        <>
            ...
            {/* Sidebar */}
            <aside
                className={`fixed top-0 left-0 z-50 h-screen w-64 bg-white border-r border-gray-200 transition-transform duration-300 ease-in-out lg:translate-x-0 lg:relative ${isOpen ? 'translate-x-0' : '-translate-x-full'
                    }`}
            >
                {/* Logo & Close Button */}
                <div className="flex items-center justify-between p-6 border-b border-gray-200">
                    <div className="flex items-center space-x-3">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-gray-900">Gestión</h2>
                            <p className="text-xs text-gray-500">Terapéutica</p>
                        </div>
                    </div>
                    <button
                        onClick={onClose}
