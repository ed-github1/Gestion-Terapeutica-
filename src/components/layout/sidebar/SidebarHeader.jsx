...
const SidebarHeader = ({ isCollapsed, userRole }) => {
    ...
    return (
        <div className="h-20 px-5 flex items-center justify-between border-b border-slate-200/60 bg-gradient-to-r from-indigo-50/50 to-purple-50/50">
            <AnimatePresence mode="wait">
                {!isCollapsed ? (
                    ...
                    <motion.div
                        ...
                        className="w-10 h-10 rounded-xl bg-gradient-to-br from-indigo-500 to-purple-600 flex items-center justify-center shadow-md mx-auto"
                    >
                        <Brain className="w-6 h-6 text-white" strokeWidth={2.5} />
                    </motion.div>
                )}
