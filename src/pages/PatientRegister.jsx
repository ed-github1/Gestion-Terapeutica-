...
const PatientRegister = () => {
  ...
  const [step, setStep] = useState(1) // 1: verify, 2: phone-otp, 3: form, 4: complete
  ...
  const verifyInviteCode = async () => {
    ...
    try {
      const response = await fetch(
        `${import.meta.env.VITE_API_URL || 'http://localhost:3000/api'}/invitations/verify/${formData.inviteCode}`,
        { method: 'GET' }
      )
        ...
        >
          <AnimatePresence mode="wait">
            ...
            {step === 2 && (
              ...
              >
                <div className="text-center mb-6">
                  ...
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">Verifica tu Teléfono</h2>
                  <p className="text-gray-600">Te enviaremos un código de verificación por SMS</p>
                </div>
                  ...
                  {!otpSent ? (
                    <>
                      <div className="bg-purple-50 rounded-2xl p-4 border border-purple-200">
                        <p className="text-sm text-gray-700">
                          <span className="font-semibold">Teléfono registrado:</span> {formData.phone}
                        </p>
                      </div>
                      <button
                        onClick={sendOTP}
                    ...
                    <>
                      <input
                        ...
                        className="w-full px-6 py-4 text-center text-3xl font-mono font-bold tracking-widest border-2 border-blue-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition bg-blue-50/30"
                        placeholder="000000"
                        maxLength={6}
                      />
            ...
            {step === 3 && (
              ...
              >
                <div className="text-center mb-6">
                  <h2 className="text-2xl font-bold text-gray-800 mb-2">Completa tu Perfil</h2>
                  <p className="text-gray-600">Información necesaria para tu expediente</p>
                </div>
