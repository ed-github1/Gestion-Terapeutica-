...
const DashboardLayoutInner = ({ children, userRole }) => {
  ...
  return (
    <div className={`${dark ? 'dark' : ''} h-screen tm-bg flex flex-col overflow-hidden`}>
      ...
      {/* Mobile Top Bar */}
      <div className="md:hidden bg-white dark:bg-gray-950 px-4 py-3 flex items-center justify-between shadow-sm fixed top-0 left-0 right-0 z-50 shrink-0">
      ...
      {/* Main Container */}
      <div className="flex-1 flex overflow-hidden pt-16 md:pt-0">
