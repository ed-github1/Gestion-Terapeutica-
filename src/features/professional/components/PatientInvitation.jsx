      ...
      >
        ...
        <div className="relative px-5 pt-5 pb-4 border-b border-gray-100">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-gray-500">Genera un enlace para que el paciente se registre</p>
            </div>
          </div>
        </div>
        ...
        <div className="px-5 py-4 space-y-4">
          ...
          <div className="space-y-1.5">
            ...
            <div className="flex items-center gap-2 border border-gray-200 rounded-xl px-3 py-2 bg-gray-50">
              {isLoading ? (
                ...
                <span className="text-xs text-gray-600 truncate flex-1 font-mono">{registrationLink}</span>
              )}
              <button
                onClick={copyLink}
                disabled={isLoading}
                className="p-1 hover:bg-gray-200 rounded-md transition-colors disabled:opacity-40"
              >
          ...
          <div className="space-y-1.5">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-3 py-2 text-sm border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
            />
            <p className="text-[10px] text-gray-400 text-right">{message.length}/{MAX_MESSAGE_LENGTH}</p>
          </div>

          {/* Preview */}
          <div className="border border-green-200 bg-green-50 rounded-xl px-4 py-3 space-y-2">
            <p className="text-[10px] font-semibold text-green-700 uppercase tracking-wider">Vista previa</p>
        ...
        <div className="px-5 pb-5 space-y-2">
          ...
          <button
            ...
            disabled={isLoading}
            className="w-full flex items-center justify-center gap-2 py-3 rounded-xl border border-gray-200 bg-white hover:bg-gray-50 text-gray-700 text-sm font-medium transition-colors disabled:opacity-50"
          >
