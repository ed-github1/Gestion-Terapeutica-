            ...
            {open && (
                <>
                    ...
                    <motion.div
                        ...
                        className="fixed z-50 inset-x-4 top-1/2 -translate-y-1/2 mx-auto max-w-md bg-white dark:bg-gray-900 rounded-2xl shadow-2xl flex flex-col overflow-hidden"
                    ...
                    >
                        ...
                        <div className="flex-1 overflow-y-auto px-5 py-3 space-y-0.5 custom-scrollbar">
                            ...
                            {error && !loading && (
                                <p className="text-xs text-center text-rose-400 py-6">{error}</p>
                            )}
