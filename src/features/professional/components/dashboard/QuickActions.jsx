            ...
            <div className="flex items-center gap-1.5">
                {actions.map((action) => (
                    ...
                    >
                        ...
                        <span className="text-[10px] md:text-[9px] font-semibold text-gray-500 leading-none text-center" style={action.labelStyle}>{action.shortLabel}</span>
                    </button>
                ))}
            </div>
        )
            ...
            {actions.map((action) => (
                ...
                >
                    ...
                    <div className="min-w-0">
                        <p className="text-sm font-semibold text-gray-900" style={action.labelStyle}>{action.label}</p>
